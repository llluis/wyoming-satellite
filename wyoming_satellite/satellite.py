...
class SatelliteBase:
    ...
    async def _send_run_pipeline(self, pipeline_name: Optional[str] = None, question_id: Optional[str] = None) -> None:
...
class WakeStreamingSatellite(SatelliteBase):
    ...
    async def event_from_wake(self, event: Event) -> None:
        ...
        if Detection.is_type(event.type):
            ...
            await self._send_run_pipeline(pipeline_name=pipeline_name, question_id=event.data.get("question_id"))
